...
# Modeli boş bir şekilde başlat
eyenet = EyeNet(nstack=checkpoint['nstack'], nfeatures=checkpoint['nfeatures'], nlandmarks=checkpoint['nlandmarks'])
eyenet.to_empty(device)
